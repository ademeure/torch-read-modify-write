...
def forward(
    ...
    h0_attn_neg = _neg_sin  # DEDUP: reuse precomputed neg(sin)
    ...
    h0_attn_neg_1 = _neg_sin  # DEDUP: reuse precomputed neg(sin)
    ...
    h1_attn_neg = _neg_sin  # DEDUP: reuse precomputed neg(sin)
    ...
    h1_attn_neg_1 = _neg_sin  # DEDUP: reuse precomputed neg(sin)
    ...
    h2_attn_neg = _neg_sin  # DEDUP: reuse precomputed neg(sin)
    ...
    h2_attn_neg_1 = _neg_sin  # DEDUP: reuse precomputed neg(sin)
    ...
    h3_attn_neg = _neg_sin  # DEDUP: reuse precomputed neg(sin)
    ...
    h3_attn_neg_1 = _neg_sin  # DEDUP: reuse precomputed neg(sin)
    ...
    h4_attn_neg = _neg_sin  # DEDUP: reuse precomputed neg(sin)
    ...
    h4_attn_neg_1 = _neg_sin  # DEDUP: reuse precomputed neg(sin)
    ...
    h5_attn_neg = _neg_sin  # DEDUP: reuse precomputed neg(sin)
    ...
    h5_attn_neg_1 = _neg_sin  # DEDUP: reuse precomputed neg(sin)
    ...
    h6_attn_neg = _neg_sin  # DEDUP: reuse precomputed neg(sin)
    ...
    h6_attn_neg_1 = _neg_sin  # DEDUP: reuse precomputed neg(sin)
    ...
    h7_attn_neg = _neg_sin  # DEDUP: reuse precomputed neg(sin)
    ...
    h7_attn_neg_1 = _neg_sin  # DEDUP: reuse precomputed neg(sin)
