...
# This replaces aten.add.Tensor for the block-0 residual connection
# (x = x + self.attn(norm(x))) with a custom CUDA kernel compiled at
# module load time. Drop-in replacement: bit-identical to aten.add.
...
def forward(
    ...
    h0_add: 'bfloat16[32, 2048, 512]' = cuda_add(add_add, h0_attn_c_proj__unsafe_view)  # MODIFIED: inline CUDA kernel (bit-identical to aten.add)
    ...
    value_embeds1_embedding: 'bfloat16[32, 2048, 512]' = aten.embedding(value_embeds_1_weight, input__32__2048)  # strides=(1048576, 512, 1), contiguous=True, view=False
    ...
    # /.autoresearch_repo/train.py:273
    # ve = self.value_embeds[str(i)](idx) if str(i) in self.value_embeds else None
    value_embeds3_embedding: 'bfloat16[32, 2048, 512]' = aten.embedding(value_embeds_3_weight, input__32__2048)  # strides=(1048576, 512, 1), contiguous=True, view=False
    ...
    # /.autoresearch_repo/train.py:273
    # ve = self.value_embeds[str(i)](idx) if str(i) in self.value_embeds else None
    value_embeds5_embedding: 'bfloat16[32, 2048, 512]' = aten.embedding(value_embeds_5_weight, input__32__2048)  # strides=(1048576, 512, 1), contiguous=True, view=False
    ...
    # /.autoresearch_repo/train.py:273
    # ve = self.value_embeds[str(i)](idx) if str(i) in self.value_embeds else None
    value_embeds7_embedding: 'bfloat16[32, 2048, 512]' = aten.embedding(value_embeds_7_weight, input__32__2048)  # strides=(1048576, 512, 1), contiguous=True, view=False
