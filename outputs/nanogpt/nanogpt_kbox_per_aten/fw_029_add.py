...
Inputs (36.9KB total):
  ...
  primals_24  float32[32]  128B
  primals_25  float32[32]  128B
  primals_26  float32[128x32]  16.0KB
  primals_27  float32[128]  512B
  primals_28  float32[32x128]  16.0KB
  primals_29  float32[32]  128B
Outputs (4.0KB total):
...
def run(inputs):
    native_layer_norm_3 = torch.ops.aten.native_layer_norm.default(inputs.add_3, [32], inputs.primals_24, inputs.primals_25, 1e-05)
    getitem_15 = operator.getitem(native_layer_norm_3, 0)
    getitem_16 = operator.getitem(native_layer_norm_3, 1)
    getitem_17 = operator.getitem(native_layer_norm_3, 2)
