"""Reference CUDA kernel for aten.div_scalar (scalar variant)."""
import torch

KERNEL_SRC = r"""
extern "C" __global__ void aten_div_scalar(const float *in0, float *out0, unsigned int n) {
...
def expected(inputs):
    x = inputs[0]
    return [torch.ops.aten.div.Scalar(inputs[0], 2.0)]
