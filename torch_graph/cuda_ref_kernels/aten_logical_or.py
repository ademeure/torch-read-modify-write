"""Reference CUDA kernel for aten.logical_or."""
import torch

KERNEL_SRC = r"""
extern "C" __global__ void aten_logical_or(const float *in0, const float *in1, float *out0, unsigned int n) {
...
def expected(inputs):
    a, b = inputs
    return [torch.ops.aten.logical_or.default(a, b).float()]
