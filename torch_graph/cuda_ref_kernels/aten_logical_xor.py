"""Reference CUDA kernel for aten.logical_xor."""
import torch

KERNEL_SRC = r"""
extern "C" __global__ void aten_logical_xor(const float *in0, const float *in1, float *out0, unsigned int n) {
...
def expected(inputs):
    a, b = inputs
    return [torch.ops.aten.logical_xor.default(a, b).float()]
