"""Reference CUDA kernel for aten.mul_scalar (scalar variant)."""
import torch

KERNEL_SRC = r"""
extern "C" __global__ void aten_mul_scalar(const float *in0, float *out0, unsigned int n) {
...
def expected(inputs):
    x = inputs[0]
    return [torch.ops.aten.mul.Scalar(inputs[0], 2.0)]
